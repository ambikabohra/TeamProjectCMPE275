...
import com.surveyapp.backend.service.PasswordResetTokenService;
...
public class ForgotMyPasswordController {
    ...
    public String forgotPasswordPost(HttpServletRequest servletRequest,
        ...
        if (passwordResetToken == null) {
            ...
            String resetPasswordURL = UserUtils.createPasswordResetUrl(servletRequest, user.getId(), token);
            LOG.debug("Password reset url: {}", resetPasswordURL);
